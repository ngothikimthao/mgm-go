...
public class Quote extends TableImpl<QuoteRecord> {
    ...
    private static final long serialVersionUID = -930047281;
    ...
    /**
     * The column <code>public.quote.content</code>.
     */
    public final TableField<QuoteRecord, String> CONTENT = createField("content", org.jooq.impl.SQLDataType.VARCHAR(255).nullable(false), this, "");
